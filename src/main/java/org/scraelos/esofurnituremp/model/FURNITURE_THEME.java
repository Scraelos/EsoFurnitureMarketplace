...
//    SI_FURNITURETHEMETYPE0("All Themes", "Alle", "Tous les thèmes", "Все стили", 0),
    ...
    SI_FURNITURETHEMETYPE17("Vampiric", "Vampirisch", "Vampirique", "Вампирский", 1),
    ...
    SI_FURNITURETHEMETYPE3("High Elf", "Hochelfen", "Haut-elfe", "Высокие эльфы", 1),
    ...
    SI_FURNITURETHEMETYPE5("Wood Elf", "Waldelfen", "Elfe des bois", "Лесные эльфы", 1),
    SI_FURNITURETHEMETYPE6("Dark Elf", "Dunkelelfen", "Elfe noir", "Темные эльфы", 1),
